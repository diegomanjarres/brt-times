...
library(dplyr)
library(ggplot2)
calle100 <- read.csv("projects/brt-times/logs0312/results/trips_calle100.txt", stringsAsFactors = F)
...
heroes <- read.csv("projects/brt-times/logs0312/results/trips_heroes.txt", stringsAsFactors = F)
