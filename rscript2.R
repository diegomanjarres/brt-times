...
matplot(flowcalle100[, 1], flowcalle100[,2], type="h", xlab="tiempo de salida", ylab="observaciones")
...
matplot(flowheroes[, 1], flowheroes[,2], type="h", xlab="tiempo de salida", ylab="observaciones")
