...
input=./logs0312/results/trips_calle100_grouped_clean.txt node averageresults.js > logs0312/results/trips_calle100_average_clean.txt
input=./logs0312/results/trips_heroes_grouped_clean.txt node averageresults.js > logs0312/results/trips_heroes_average_clean.txt
